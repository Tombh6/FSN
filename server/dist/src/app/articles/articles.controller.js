...
let ArticlesController = class ArticlesController {
    ...
    async getArticles(body) {
        return this.articlesService.getAllArticles(body.filtersState, body.location, body.pageNumber);
    }
    async getSources(body) {
        return this.articlesService.getSources(body.filtersState);
    }
    async getKeywords(body) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], ArticlesController.prototype, "getSources", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], ArticlesController.prototype, "getKeywords", null);
